...
ALTER TABLE game ADD COLUMN esrb esrb_type NOT NULL;

ALTER TABLE game ADD COLUMN created_at TIMESTAMP NOT NULL;

ALTER TABLE game ADD COLUMN created_by varchar(32) NOT NULL;

ALTER TABLE game ADD COLUMN updated_at TIMESTAMP;

ALTER TABLE game ADD COLUMN updated_by varchar(32);
